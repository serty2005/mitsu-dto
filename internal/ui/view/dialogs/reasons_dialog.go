...
// ShowReasonsDialog открывает диалог выбора причин перерегистрации и возвращает выбранные коды
func ShowReasonsDialog(owner walk.Form, currentCodes string) (string, bool) {
	var dlg *walk.Dialog
